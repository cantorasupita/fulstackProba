...
import {addItem, minusItem, removeItem, clieanItem} from '../redux/slices/cartSlice';
...
const  CartItem:React.FC<CartItemProps> = ({id, title, type, size, price, count, imageUrl}) =>{
    ...
    return(
      ...
      <div className="cart__item-count">
          <button onClick={onClickMinus} disabled="" className="button button--outline button--circle cart__item-count-minus">
