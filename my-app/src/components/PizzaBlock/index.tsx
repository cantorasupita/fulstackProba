...
//AC
import {addItem, removeItem, clieanItem} from '../../redux/slices/cartSlice';
//selectors
...
//-------------------------------------------------------------------
const  PizzaBlock:React.FC<PizzaBlock> = ({id, title, price, imageUrl, sizes, types}) =>{
